AnimatedGifControl(GuiNameOrHwnd, GifFilePath, ControlOptions="") {
	...
	Draw(GuiNameOrHwnd, ObjectName, GifWidth, GifHeight, ControlOptions, GifFilePath, bgColor)
...
Draw(GuiNameOrHwnd, ObjectName, GifWidth, GifHeight, ControlOptions, Source, bgColor){
	Static
